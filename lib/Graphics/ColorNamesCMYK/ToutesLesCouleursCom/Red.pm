package Graphics::ColorNamesCMYK::ToutesLesCoulersCom::Red;
...
# BEGIN_CODE
#use HashData::Color::CMYK::ToutesLesCouleursCom::Red;
#
#print 'our $NAMES_CMYK_TABLE = {', "\n";
#
#my $hd = HashData::Color::CMYK::ToutesLesCouleursCom::Red->new;
#
